...
class Backend extends Controller
{
    ...
    public function getenter(){
        $enterId = Cache::get($this->auth->user_id.'enterId');
        ...
        if(!$enterId){
            if($this->auth->usertype=='custom'){
                ...
                if($userId){
                    $enter = Db::name('enterprise_custom')->where('custom_id','=',$this->auth->user_id)->order('id desc')->find();
                    if($enter){
                        config('enterId',$enter['enterprise_id']);
                        return $enter['enterprise_id'];
                    }
                }
            }
        }else{
