...
class Wxappletlogin{
    ...
    public $secrect_key='45c2e66c67347cb36e5cfca560e33d17';//商户支付秘钥

    /**
     * Created by PhpStorm.
     * User:lang
     * time:2024年3月12月 12:35:01
     * ps:获取小程序手机号
     */
    public function getPhoneNumber($code){
        ...
        $data['code'] = $code;
        $authorize = $this->https_request($url,$data,'json');
       return $authorize;
    }
...
//        return $authorize;
    ...
    public function getAccessToken(){
        ...
        $token = $assessToken::getappletToken();
