define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'copycontract/index' + location.search,
                    add_url: 'copycontract/add',
                    edit_url: 'copycontract/edit',
                    del_url: 'copycontract/del',
                    multi_url: 'copycontract/multi',
                    import_url: 'copycontract/import',
                    table: 'contract',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'copycontract/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
